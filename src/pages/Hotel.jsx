...
const Hotel = () => {
  ...
  const hotelId = location.pathname.split("/")[2]; //same-> location.pathname.slice(8);
        ...
        <>
            ...
            <div className="hotelWrapper">
              ...
              <div className="hotelDetails">
                ...
                <div className="hotelDetailsPrice">
                  ...
                  <h2>
                    <strong>
                      {String(days * data.cheapestPrice * options.room)}
                    </strong>
                    ({days} noches)
                  </h2>
          ...
          {openModalReserve && (
            <ModalReserve
              ...
              setOpenModalReserve={setOpenModalReserve}
              hotelId={hotelId}
            />
          )}
        </>
